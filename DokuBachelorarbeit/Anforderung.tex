...
Die im Kapitel \ref{sec:Zielsetzung} definierten Ziele sollen mit den folgenden Anforderungen gewährleistet werden.
	...
	Es sollte eine möglichst einfache und sehr mächtige Skriptsprache verwendet werden, mit der Automatisierungen gut möglich sind. Eine Oberfläche kann vorhanden sein ist aber kein muss. Eine Eingabe über die Konsole oder über die GUI soll möglich sein. %TODO Weitere Vorteile von Python herausfinden 
