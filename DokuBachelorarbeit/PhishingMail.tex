...
Ein E-Mail-Muster entspricht einem Lückentext, bei dem die entsprechenden Lücken mit den gewonnen Daten ergänzt werden. Ängste, Freude,.. ausgenutzt?!%TODO Quelle suchen.
Dabei stellt sich die Frage, wie die E-Mail-Texte möglichst passend kategorisiert werden können.
	\subsection{Kategorien erstellen}
	Grundsätzlich können die Muster in zwei große Kategorien unterteilt werden. Es gibt einen private und berufliche Kategorie. Der unterschied zwischen privat und beruflich besteht in der Art und Weise wie ein Text geschrieben wird. Das bedeutet, dass ein privates Muster in einer Alltagssprache und ein berufliches Muster in einer formelleren Sprache erstellt wird. Um dies zu erkennen werden zu beginn Abfragen gemacht, welche Daten bekannt sind. Wenn die Firma, Universität oder ähnliches bekannt ist, wird beispielsweise ein berufliches Muster gewählt.\\
	Diese beiden Kategorieren haben weitere Muster, welche unterschiedliche Daten in den Lückentext einbinden.
