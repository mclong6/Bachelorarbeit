...
\begin{center}
\textcolor{red}{Erstellung eines Tools zur automatisierten Informationsbeschaffung von personenbezogenen Daten in Verbindung mit einem automatisierten Phishing-Mailgenerators} % Titel der Arbeit
\end{center}
}
