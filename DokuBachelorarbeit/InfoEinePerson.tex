...
Für die Personensuche im Internet wird die Google-Suchmaschine verwendet. Gesucht wird nach den eingegebenen Daten, welche über die Konsole eingelesen werden.
	...
	Zu Beginn werden alle Personen-Variablen mit einem leeren String initialisiert. Das bedeutet, alle Variablen, zu denen keine Information eingegeben wurde, enthalten einen leeren String.
		...
		%TODO Bild ohne roten Linien einfügen
			...
			Zu den verwendeten Social-Media-Webseiten gehören Instagram, Facebook, Twitter, Xing und LinkedIn. Für diese Webseiten werden Fake-Accounts und ein eigener Selenium Webdriver erstellt, welcher ausschließlich für die Social-Media-Seiten zuständig ist. Der Selenium Webdriver meldet sich automatisch auf den Webseiten an, damit die Möglichkeit besteht, vollständige Profile anzuzeigen. Die gewonnen Informationen werden dem Profil der gesuchten Person hinzugefügt und bei der Google-Suche zusätzlich ergänzt.
...
\section{Umsetzung der Personenidentifizierung}
	\subsection{Kontakte in Betracht ziehen}
		...
		Diese Methode funktioniert auf der Webseite LinkedIn nicht. Es gibt dort keine Möglichkeit die Kontakte der gesuchten Person anzuzeigen. Bei Xing kann ein Nutzer einstellen, ob diese Ansicht freigegeben werden oder nicht. Dadurch sind die Kontakte bei vielen Usern nicht erkennbar. Facebook, Twitter und Instagram lassen sich die Kontakte der gesuchten Person anzeigen. Allerdings wird dafür ein Account benötigt.\\
		...
		\begin{figure}[H]
			\centering
			\includegraphics[ scale=0.5]{bilder/algo_instagram.png}
			\caption{Pop-up-Fenster mit abonnierten Profilen}
			\label{img:Algorithmus zum durchscollen des pop-up-Fensters}
		\end{figure}

		Hartkodierung
		%TODO Schreiben und umsetzten
