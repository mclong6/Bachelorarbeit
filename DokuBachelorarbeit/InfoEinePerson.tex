...
Für die Personensuche im Internet wird die Google-Suchmaschine verwendet. Gesucht wird nach den eingegebenen Daten. Dafür werden die Daten über eine Konsole eingelesen.
	...
	Zu Beginn werden alle Personen-Variablen mit einem leeren String initialisiert. Das heißt, alle Variablen, zu denen keine Information eingegeben wurde, enthalten einen leeren String.
