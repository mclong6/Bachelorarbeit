...
Eine Weitere Möglichkeit wäre selbst ein Algorithmus zu entwickeln, der alle möglichen Mail-Adressen aus den Kombinationen von Vorname, Nachname, Geburtsjahr und den bekanntesten Mail-Providern generiert. Diese Adressen werden anschließend auf Validität geprüft. Hierfür gab es früher eine \textit{VRFY} Anfrage von SMTP. Mit dieser Anfrage konnte eine angegebene E-Mail-Adresse überprüft werden. Allerdings wurde der Dienst von Spammern ausgenutzt und wird von den meisten SMTP-Servern nicht mehr zu Verfügung gestellt.\cite{balduzzi2010abusing}\\
Aus diesem Grund muss die Validität auf einem anderen Weg geprüft werden. Eine Möglichkeit zur Prüfung ist die Verwendung bereitgestellter Webseiten, bei der die zu prüfenden E-Mail-Adresse eingetragen werden kann und eine Rückmeldung bekommt ob die Adresse verwendet wird oder nicht. Eine Webseite dafür wäre "'\textit{https://centralops.net/co/}"'. Die Alternative dazu wäre ein Skript zu entwickeln, welches die Validität der Adresse prüft.\\
Falls die Firma ,bei der die Zielperson angestellt ist, bekannt ist, kann auf der Firmenwebseite nach E-Mail-Adressen gesucht werden. Dadurch kann die Domain einer E-Mailadresse bestimmt werden und die Anzahl an zu genierenden Adressen ist um einen großen Teil geringer.
