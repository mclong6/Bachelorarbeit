...
\label {sec:Social Engineering} %Label des Unterkapitels
	...
	Grundsätzlich werden bei einem Social Engineering Angriff menschliche Wünsche, Ängste und verbreitete Verhaltensmuster verwendet, um ein Opfer zu manipulieren.\cite{LeitfadenSE}\\
		...
		\subsection{Phishing}
		Das Wort Phishing wird von dem Wort "'fishing"' abgeleitet. Der Vergleich ist zutreffend, da der Angreifer ähnlich einem Angler nach Informationen "'fischt"'. Das "'Ph"' kommt von "'sophisticated"' und meint damit, dass die Angreifer ausgeklügelte Techniken verwenden um an Informationen heranzukommen.\cite{PhishingExposed}\\
